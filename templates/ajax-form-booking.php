...
<form id="booking-form" class="need-validation" novalidate>
    ...
    <label for="privacy-consent">
        <input type="checkbox" name="privacy-consent" id="privacy-consent" required> Jeg samtykker til at personopplysningene jeg sender inn her kan behandles i tråd med <?php bloginfo('name') ?> sin personvernerklæring.
        <div class="invalid-feedback">
